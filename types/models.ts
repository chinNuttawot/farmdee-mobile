...
export interface Expense { id: number; label: string; total_amount: number; date: string; }
export interface JobCost { id: number; taskId: number; kind: 'labor'|'material'|'transport'; total_amount: number; note?: string; date: string; }
